	...
	implements FocusListener, DocumentListener
{
	...
	private int focusLost;
        private boolean isJTextArea = false;

	public TextPrompt(String text, JTextComponent component, boolean isTrue)
	{
		this(text, component, Show.ALWAYS,isTrue);
               
                
	}

	public TextPrompt(String text, JTextComponent component, Show show,boolean isJTextArea)
	{
		this.component = component;
                this.isJTextArea = isJTextArea;
		setShow( show );
